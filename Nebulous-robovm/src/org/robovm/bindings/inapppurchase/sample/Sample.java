	...
	public void didFinishLaunching(UIApplication application) {
		iapManager = new InAppPurchaseManager(new InAppPurchaseListener() {
			...
			public void transactionRestoreFailed(
					NSArray<SKPaymentTransaction> transactions, NSError error) {
				// Something went wrong. Possibly no Internet connection or user
				// cancelled.
			}
		...
		iapManager.requestProducts("com.business.game.consumable",
				"com.business.game.nonconsumable");
		...
		if (iapManager.canMakePayments() && appStoreProducts != null) {
			iapManager.purchaseProduct(appStoreProducts
					.get("com.business.game.consumable"));
		}
